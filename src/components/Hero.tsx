        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 fade-in">
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif text-primary-foreground leading-tight">
              Оптимизируйте бизнес с <span className="text-accent">Ари Консалт</span>
            </h1>

            <p className="text-lg md:text-xl text-primary-foreground/90 max-w-xl mx-auto lg:mx-0">
              <span className="text-accent font-semibold">
                В 2026 году законы ужесточаются, издержки растут на 15%:
              </span>{" "}
            ...
            <p className="text-base md:text-lg text-primary-foreground/80 max-w-xl mx-auto lg:mx-0">
              Бухгалтерия, 1С и защита интеллектуальной собственности для малого и среднего бизнеса. Сократите расходы
              на <span className="text-accent font-semibold">20%</span> за 30 дней, избегите штрафов от новых налогов и
              сохраните бизнес в росте.
            </p>
            ...
            <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-xl p-6 border border-accent/30 fade-in-up animation-delay-200">
              <p className="text-primary-foreground/90 text-base md:text-lg leading-relaxed">
                ...
                <span className="font-bold text-accent"> защитили IP</span>. Получите первую бесплатную консультацию — и
                превратите угрозы в возможности для
                <span className="font-bold text-accent"> приумножения капитала</span>. Не ждите кризиса: действуйте
                сейчас, чтобы ваш бизнес не просто выжил, а<span className="font-bold text-accent"> расцвел!</span>
              </p>
            </div>
            ...
            {/* Trust Indicators */}
            <div ref={counterRef} className="flex flex-wrap justify-center lg:justify-start gap-6 pt-6">
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0 lg:ml-auto">
            <div className="bg-card rounded-xl shadow-2xl p-6 md:p-8 fade-in-up animation-delay-200">
              <div className="text-center mb-6">
                <h2 className="text-xl md:text-2xl font-serif text-foreground mb-2">Получите бесплатный аудит</h2>
                <p className="text-muted-foreground text-sm">Экономьте время уже сегодня</p>
              </div>
              ...
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button variant="cta" type="submit" className="w-full h-12 text-base pulse-gold">
                    Получите первую <br /> бесплатную консультацию
                  </Button>

                  <div className="flex items-center gap-2 justify-center text-sm text-accent w-full flex-wrap">
                    <CheckCircle className="w-4 h-4 flex-shrink-0" />
                    <span className="text-center break-words">
                      Избегите трудностей, сохраните бизнес <br /> и приумножьте капитал
                    </span>
                  </div>
                </form>
              ) : (
